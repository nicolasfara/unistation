    ...
    <div class="container">
      <div class="row">
        ...
        <div class="col s3 stats">
          <i class="fas fa-hamburger fa-3x orange-text" aria-hidden="true"></i>
          <div class="counting" data-count="{{ $products_count }}">0</div>
          <h5>Prodotti disponibili</h5>
        </div>

        <div class="col s3 stats">
          <i class="fas fa-store fa-3x orange-text" aria-hidden="true"></i>
          <div class="counting" data-count="{{ $vendors_count }}">0</div>
          <h5>Venditori</h5>
        </div>

        <div class="col s3 stats">
          <i class="fas fa-user fa-3x orange-text" aria-hidden="true"></i>
          <div class="counting" data-count="{{ $clients_count }}">0</div>
          <h5>Clieni soddisfatti</h5>
        </div>

        <div class="col s3 stats">
          <i class="fas fa-shipping-fast fa-3x orange-text" aria-hidden="true"></i>
          <div class="counting" data-count="{{ $orders_count }}">0</div>
