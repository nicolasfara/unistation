    ...
    <div class="container section">
        <div class="row ">
            <div class="logo col s12 m6">
                <img class="responsive-img logo-home" src="{{ asset('images/logo.png') }}" alt="Logo UniStation">
                ...
                <div class="slider center">
                    <ul class="slides">
                        <li>
                            ...
                            <p>Registrati e accedi come utente Unistation</p>
                        </li>
                        <li>
                            <span class="step ui">2</span>
                            <img class="ui inline image" src="{{ asset('images/how_to_4.png') }}" style="max-width: 150px; height: auto; margin-top: 30px;" alt="Cloche con timer">
                            <p>Seleziona le varie portate e completa l'ordine indicando l'ora di consegna</p>
                        </li>
                        <li>
                            <span class="step ui">3</span>
                            <img class="ui inline image" src="{{ asset('images/how_to_3.png') }}" style="max-width: 150px; height: auto; margin-top: 30px;" alt="Motorino">
                            <p>Concludi l'ordine e attendi la notifica per email della tua freccia</p>
                        </li>
                        <li>
                            ...
                            <p>La freccia consegnerà l'ordine nella fascia oraria stabilita</p>
                        </li>
                    </ul>
                </div>
            </div>
