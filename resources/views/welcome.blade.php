             ...
             <div class="slider center">
                <ul class="slides">
                    <li>
                        ...
                        <img class="ui inline image" src="{{ asset('images/how_to_2.png') }}" style="max-width: 150px; height: auto; margin-top: 30px;">
                    ...
                    <li>
                        ...
                        <img class="ui inline image" src="{{ asset('images/how_to_4.png') }}" style="max-width: 150px; height: auto;margin-top: 30px;">
                    ...
                    <li>
                        ...
                        <img class="ui inline image" src="{{ asset('images/how_to_3.png') }}" style="max-width: 150px; height: auto;margin-top: 30px;">
                    ...
                    <li>
                        ...
                        <img class="ui inline image" src="{{ asset('images/how_to_1.png') }}" style="max-width: 150px; height: auto;margin-top: 30px;">
